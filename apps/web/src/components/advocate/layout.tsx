    ...
    <div className="min-h-screen flex bg-background">
      ...
      <aside className={cn(
        ...
        <div className="flex items-center gap-2 p-4 border-b border-border">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-secondary to-primary text-white">
            <Scale className="h-4 w-4" />
          </div>
          <div>
            <span className="font-bold text-sm">Nyaya<span className="text-secondary">AI</span></span>
            <div className="text-[10px] text-muted-foreground">Advocate Workspace</div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-14 border-b border-border flex items-center justify-between px-4 lg:px-6 glass sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2">
            ...
            <ThemeToggle />
            <div className="h-8 w-8 rounded-full bg-gradient-to-br from-secondary to-primary flex items-center justify-center text-white text-xs font-bold">A</div>
          </div>
        </header>
